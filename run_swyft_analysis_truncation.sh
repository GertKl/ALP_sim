...
python ${results_dir}/run_truncation_rounds.py -argsstr "$1" -path "$results_dir"  -trial "$i"


if [ $simulate == 1 ] && [ -e $results_dir/sim_output/sim_outputs ] ; then
...
if { [ $train == 1 ] || [ $draw_DRP == 1 ] ; } && [ -e $results_dir/train_output/train_outputs ] ; then
